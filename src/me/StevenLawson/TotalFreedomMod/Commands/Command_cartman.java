...
public class Command_cartman extends TFM_Command
{
    @Override
    public boolean run(final CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.adminAction(sender.getName(), " Cartman is mad with " + player.getName(), true);
        ...
        TFM_Util.bcastMsg(sender.getName() + " is Cartman'ing " + player.getName() + "!!!!", ChatColor.GREEN);
        TFM_Util.bcastMsg(player.getName() + " is being Cartman'd by " + sender.getName() + " Because he is a stupid!", ChatColor.GREEN);
        TFM_Util.bcastMsg(player.getName() + ", hey you know what IceGamer94 is saying right now for you?? HE SAYS YOU ARE A LITTLE BITCH! ASSHOLE!", ChatColor.DARK_RED);
        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                ...
                // kick player
                player.kickPlayer(ChatColor.DARK_GREEN + "IceGamer94 is very angry bird with you! Please tell me, WHAT THE FUCK WITH YOU?");
